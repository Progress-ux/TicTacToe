...
TicTacToe::TicTacToe()
    : cells{'0', '1', '2', '3', '4', '5', '6', '7', '8'}, currentPlayer('x'),
      moveCount(0) {}
...
bool TicTacToe::checkDraw() { return moveCount > 8; }
...
char TicTacToe::getCurrentPlayer() { return currentPlayer; }
...
std::vector<char> &TicTacToe::getCells() { return cells; }

void TicTacToe::fieldRendering() const {
